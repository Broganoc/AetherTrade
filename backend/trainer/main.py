...
def run_training(
    ...
    return {
        "status": "started", "symbols": [s.strip() for s in symbol.split(",")],
        "model_name": model_name, "timesteps": timesteps, "chunks": chunks,
        "eval_episodes": eval_episodes, "save_every": save_every,
        "start": start, "end": end,
    }
